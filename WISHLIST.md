BIG
+ Statistics about cards (how many goblins, how many 1 mana, how many instants)
+ Deck creation page
+ Advanced card group selection (select all goblins => select between 2 and 3 mana => select red)
...
+ Option to make your account public or private. Public accounts will be selectable on login and show in an extra tab.

SMALL
+ Add sort option by date for view modes.
