...
export default async function Colofon() {
  return (
    <Box m={2}>
      ...
      <Typography variant="body1" gutterBottom>
        ...
        <Link href="https://github.com/lucasmoeskops" target="blank">
          Lucas Moeskops
        </Link>
        .<br />
        Uses{" "}
      ...
      <List>
        ...
        <ListItem>
          Added a linting configuration and optimized some parts of the code.
        </ListItem>
      </List>
      <Typography variant="body2" gutterBottom>
      ...
      <List>
        ...
        <ListItem>
          Fix calculation error for total cards in merchant mode. (Thanks to
          Renske)
        </ListItem>
        <ListItem>
          Fix issue where cards of the previous user would remain visible after
      ...
      <List>
        ...
        <ListItem>
          Make background more stable in case of slow API&apos;s, and provide a
      ...
      <List>
        <ListItem>
          Background stays the same once you login. Changes every 15 seconds on
          the intro screen.
        </ListItem>
      ...
      <List>
        ...
        <ListItem>
          Current applied filters are written as readable string in the
          overview.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          Fixed an issue that filter context was not saved when refreshing the
          page.
        </ListItem>
      ...
      <List>
        <ListItem>
          Improved the login screen with a nice random card artwork background
          image.
        </ListItem>
        <ListItem>
          Fixed a bug that a graph icon is not shown on a card if the current
          price change is exactly 0.
        </ListItem>
      </List>
      <Typography variant="body2" gutterBottom>
      ...
      <List>
        <ListItem>
          Added an icon next to cards in the merchant mode that shows a pop-up
          with their price history since july 2025.
        </ListItem>
      </List>
      <Typography variant="body2" gutterBottom>
      ...
      <List>
        <ListItem>
          Newly added cards will show up directly instead of after a new
          release.
        </ListItem>
      </List>
      <Typography variant="body2" gutterBottom>
